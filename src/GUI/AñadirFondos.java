 ...
 * @author roban
 */
public class AñadirFondos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btn_aceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, -1, -1));
        ...
        getContentPane().add(btn_cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, -1, -1));
        ...
        getContentPane().add(btn_add, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 90, 60, -1));
    ...
    private void apertura(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_apertura
        ...
        ArrayList<String> tipoIngreso = base.tipoIngreso();
        cbox_categoria.removeAllItems();
        for(int i=0; i<tipoIngreso.size(); i++){
            cbox_categoria.addItem(tipoIngreso.get(i));
        }
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        BaseDatos base = factory.basedatos();
        base.addCatFondos(this.txt_nuevaCat.getText());
